...
function CreateUserV2() {
        ...
        return (
            ...
            >
                ...
                <TextField
                    ...
                    size='small'
                    variant='standard'
                    InputProps ={ inputProps( form.username, 'username' ) }
                ...
                <TextField
                    ...
                    size='small'
                    variant='standard'
                    InputProps = { inputProps( form.password, 'password' ) }
                    onChange = { handleFormChange }
                    sx={inputStyles}
                    value = { form.password }
                />
                ...
                <TextField
                    ...
                    size='small'
                    variant='standard'
                    InputProps = { inputProps( form.confirmPassword, 'confirmPassword' ) }
                    onChange = { handleFormChange }
                    sx={inputStyles}
                ...
                <TextField
                    ...
                    size='small'
                    variant='standard'
                    InputProps = { inputProps( form.email, 'email' ) }
                    onChange = { handleFormChange }
                    sx={inputStyles}
                    value = { form.email }
                />
    ...
    // Input Props Render 
    const inputProps = ( input, fieldName ) => { 
