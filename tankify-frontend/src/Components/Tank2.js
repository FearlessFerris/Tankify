...
function Tank2() {
    ...
    // Tank Description / Specs Render 
    const renderTankDescription = () => {
        return (
            <Paper
                elevation={4}
                style={{
                    ...
                    >
                        <Button
                            ...
                            sx={{
                                ...
                                fontStyle: 'bold',
                                fontSize: '1rem',
                                width: expand.description ? '18rem' : '12rem',
                                transition: 'all 0.3s ease, width 0.3s ease',
                                whiteSpace: 'nowrap',
                                overflow: 'hidden',
                                '&:hover': {
                ...
                >
                    <Button
                        ...
                        sx={{
                            ...
                            fontStyle: 'bold',
                            fontSize: '1rem',
                            width: expand.firepower ? '16rem' : '12rem',
                            transition: 'all 0.3s ease, width 0.3s ease',
                            whiteSpace: 'nowrap',
                            overflow: 'hidden',
                            '&:hover': {
                ...
                >
                    <Button
                        ...
                        sx={{
                            ...
                            fontStyle: 'bold',
                            fontSize: '1rem',
                            width: expand.survivability ? '16rem' : '12rem',
                            transition: 'all 0.3s ease, width 0.3s ease',
                            whiteSpace: 'nowrap',
                            overflow: 'hidden',
                            '&:hover': {
                ...
                >
                    <Button
                        ...
                        sx={{
                            ...
                            fontStyle: 'bold',
                            fontSize: '1rem',
                            width: expand.mobility ? '16rem' : '12rem',
                            transition: 'all 0.3s ease, width 0.3s ease',
                            whiteSpace: 'nowrap',
                            overflow: 'hidden',
                            '&:hover': {
                ...
                >
                    <Button
                        ...
                        sx={{
                            ...
                            fontStyle: 'bold',
                            fontSize: '1rem',
                            width: expand.spotting ? '16rem' : '12rem',
                            transition: 'all 0.3s ease, width 0.3s ease',
                            whiteSpace: 'nowrap',
                            overflow: 'hidden',
                            '&:hover': {
